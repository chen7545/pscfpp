#ifndef PSPC_FOURIER_WC_MOVE_H
#define PSPC_FOURIER_WC_MOVE_H
...
namespace Pspc
{
   ...
   /**
   * FourierWcMove is a Monte Carlo move in fourier space
   *
   * \ingroup Pspc_Simulate_McMove_Module
   */
   template <int D>
   class FourierWcMove : public McMove<D>
   {
   ...
   public:
      ...
      */
      FourierWcMove(McSimulator<D>& simulator);
   ...
   private:
      ...
      */
      ...
      /// Local value of eigencomponents of the w fields.
      DArray< RField<D> > wc_;
      
      // Change in one component of wc for real part
      RField<D> dwcR_;
      
      // Change in one component of wc for imaginary part
      RField<D> dwcI_;
   ...
   extern template class FourierWcMove<1>;
   extern template class FourierWcMove<2>;
   extern template class FourierWcMove<3>;
   #endif
