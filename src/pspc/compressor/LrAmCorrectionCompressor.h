#ifndef PSPC_LR_AM_CORRECTION_COMPRESSOR_H
#define PSPC_LR_AM_CORRECTION_COMPRESSOR_H
...
namespace Pspc
{
   ...
   *
   * Class LrAmCorrectionCompressor implements an Anderson mixing algorithm in
   ...
   */
   template <int D>
   class LrAmCorrectionCompressor 
   ...
   public:
      ...
      */
      LrAmCorrectionCompressor(System<D>& system);

      /**
      * Destructor.
      */
      ~LrAmCorrectionCompressor();
   ...
   private:
      ...
      */
      ...
      /**
      * Residual in real space after mixing step.
      */
      RField<D> residM_;
      
      /**
      * Residual in Fourier space after mixing step.
      */
      RFieldDft<D> residKM_;
      ...
      */
      ...
      /**
      * Gaussian correction based on wavevector
      * f(q) = A * e^{-(q-q*)^2 / (2sigma^2)}
      */
      double fCorrection(double q);
      
      /**
      * Compute Gaussian correction for each wavevector
      */
      void fCorrections();
   ...
   extern template class LrAmCorrectionCompressor<1>;
   extern template class LrAmCorrectionCompressor<2>;
   extern template class LrAmCorrectionCompressor<3>;
   #endif
