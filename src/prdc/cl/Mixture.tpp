#ifndef PRDC_CL_MIXTURE_TPP
#define PRDC_CL_MIXTURE_TPP
...
namespace Cp {
   ...
   */
   ...
   const
   {
      ...
      fieldIo().writeCFields(filename, blockCFields, unitCell());
   }
   #endif
   ...
   */
                                  ...
                                  int sliceId) const
   {
      ...
      fieldIo().writeCField(filename, field, unitCell());
   }
   ...
   */
                                  ...
                                  int directionId) const
   {
      ...
      for (int i = 0; i < ns; ++i) {
         ...
         fieldIo().writeCField(file, propagator.q(i), unitCell(),
                                   hasHeader);
      }
      file.close();
   }
